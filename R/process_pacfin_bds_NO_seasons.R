...
# 		
#		Written by Chantel Wetzel (adapted by Vlada Gertseva)
#
##################################################################################################
...
dir <- "C:/SS/Petrale/Petrale2023/petrale/data-raw/PacFIN.Utilities_Ian"
setwd(dir)
...
# Each state should be kept separate for state based expansions
