# Projection table ----------------------------------------------------
# by Brian Langseth
# copied from https://github.com/pfmc-assessments/canary_2023/blob/main/code/figures_for_document.R
...
tab <- read.csv(file.path(mod.34.10$inputs$dir, "tables_no_format/tables/g_Projections_ES.csv"))
man <- gmt_table
