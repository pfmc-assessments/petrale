...
# summarize total catch by area
  ...
  dplyr::group_by(PACFIN_CATCH_AREA_NAME) |>
...
writeLines(
  con = "data-raw/foreign/Canadian_catch_landed_in_Washington.csv",
  text = c(
...
# mydir <- "data-raw/Triennial_Canada_2-July-2024"
# dir.create(mydir)

# extract catch
catch <- nwfscSurvey::pull_catch(
  common_name = "petrale sole",
  survey = "Triennial.Canada",
  dir = mydir
)
table(catch$Year)
