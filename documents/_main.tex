...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{../models/2023.a024.018_min_sample_retuned/plots/catch2 landings stacked.png}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{../models/2023.a024.018_min_sample_retuned/plots/ts7_Spawning_output.png}
\caption{Estimated time series of spawning output for the base model.\label{fig:es-ssb}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{../models/2023.a024.018_min_sample_retuned/plots/ts9_Relative_spawning_output.png}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{../models/2023.a024.018_min_sample_retuned/plots/ts11_Age-0_recruits_(1000s).png}
\caption{Estimated time series of age-0 recruits (1000s) for the base model.\label{fig:es-recruits}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{../models/2023.a024.018_min_sample_retuned/plots/recdevs1_points.png}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{../models/2023.a024.018_min_sample_retuned/plots/SPR2_minusSPRseries.png}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{../models/2023.a024.018_min_sample_retuned/plots/SPR4_phase.png}
\caption{Phase plot of estimated 1-SPR versus fraction unfished for the base model.\label{fig:es-phase}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{../models/2023.a024.018_min_sample_retuned/plots/yield2_yield_curve_with_refpoints.png}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{../models/2023.a024.018_min_sample_retuned/plots/data_plot2.png}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{../models/2023.a024.018_min_sample_retuned/plots/catch16 landings + dead discards.png}
