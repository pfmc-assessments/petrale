...
A new maturity ogive was developed for this assessment (M. Head pers. comm.) based on an analysis of 553 ovary samples collected from 2015 to 2021 by port samlers in Washington and Oregon as well as on board the \Gls{s-wcgbt} (Figures \ref{fig:mod-est-len-age2} and \ref{fig:maturity}). Very little difference in biological and functional maturity was observed and there was evidence of only a minimal amount of skip spawning. The estimated length at 50\% maturity was 35.45, which was similar to the 33.1 cm used in the previous assessment which was based on samples from a narrower geographic range [@hannah_length_2002].
