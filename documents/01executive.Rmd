...
The relative spawning output of `r spp` was estimated to have dropped below the management target of $B_{25\%}$. 



Unfished spawning stock output for`r spp` is estimated to be 22.9065 million eggs (95% confidence interval: 18-28 million eggs). The management target for `r spp` is defined as 25% of the unfished spawning output ($B_{25\%}$), which is estimated by the model to be 5.72662 million eggs (95% confidence interval: 4.5-6.9), which corresponds to an exploitation rate of 0.18. This harvest rate provides an equilibrium yield of 2480.73 mt at $B_{25\%}$ (95% confidence interval: 2120-2841 mt). The model estimate of maximum sustainable yield (MSY) is 2481.72 mt (95% confidence interval: 2121-2842 mt). The estimated spawning stock output at MSY is 5.51571 million eggs (95% confidence interval: 4.3-6.7 million eggs). The exploitation rate corresponding to the estimated  $F_{MSY}$ proxy of 29% is 0.18. The equilibrium estimates of yield relative to biomass is provided in Figure XX.
