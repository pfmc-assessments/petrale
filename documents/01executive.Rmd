...
`r Spp` have been caught in the flatfish fishery off the U.S. Pacific coast since the late 19th century. The earliest catches of `r spp` are reported in 1876 in California and 1884 in Oregon. `r Spp` were lightly exploited during the early 1900s, but by the 1950s, the fishery was well developed with the stock showing declines in biomass and catches (Figures \ref{fig:Exec_catch1} and \ref{fig:Spawnbio_all}). The rate of decline in spawning biomass accelerated through the 1970s reaching minimums generally around or below 10% of the unexploited levels during the 1980s through the early 2000s (Figure \ref{fig:RelDeplete_all}). `r Spp` has  consistently been the most commercially valuable flatfish targeted in the California Current Ecosystem. `r Spp` are caught nearly exclusively by trawl fleets; non-trawl gears contribute only a small fraction of the catches across all years. `r Spp` are a desirable market species and discarding has historically been low. 
...
The model includes fishery data in the form of catches, discard rates and average weights, length- and age-frequency data. Biological data are derived from both port and on-board observer sampling programs. The National Marine Fisheries Service (NMFS) \gls{s-tri} (1980, 1983, 1986, 1989, 1992, 1995, 1998, 2001, and 2004) and the \Gls{s-wcgbt} (2003-2022) relative biomass indices and biological sampling provide fishery independent information on relative trend and demographics of the `r spp` stock.
