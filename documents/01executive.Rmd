...
The base model estimate for 2023 spawning depletion is 33.6\%. The primary axis of uncertainty about this estimate used in the decision table was based on female natural mortality. Female natural mortality in the assessment model is estimated using meta-analytical prior, based on the maximum age of 32 years. The value of female natural mortality estimated in the base model is 0.142. Female natural mortality value for high state of nature is 0.072. The natural mortality value for low state of nature is 0.219.
