...
This assessment uses the stock assessment framework Stock Synthesis (SS3; (Methot and Wetzel 2013)). Version:
...
Unfished spawning stock output for`r spp` is estimated to be 22.9065 trillion eggs (95% confidence interval: 18-28 trillion eggs). The management target for `r spp` is defined as 25% of the unfished spawning output ($B_{25\%}$), which is estimated by the model to be 5.72662 trillion eggs (95% confidence interval: 4.5-6.9 trillion eggs), which corresponds to an exploitation rate of 0.18. This harvest rate provides an equilibrium yield of 2480.73 mt at $B_{25\%}$ (95% confidence interval: 2120-2841 mt). The model estimate of maximum sustainable yield (MSY) is 2481.72 mt (95% confidence interval: 2121-2842 mt). The estimated spawning stock output at MSY is 5.51571 million eggs (95% confidence interval: 4.3-6.7 million eggs). The exploitation rate corresponding to the estimated  $F_{MSY}$ proxy of 29% is 0.18. 
