...
\item Studies on stock structure and movement of `r spp` indicating transboundary movement of `r spp` between U.S. and Canadian waters. Within the scope of this assessment, we explored including multiple data sources from British Columbia waters to the base model via sensitivity analysis. Further studies of transboundary movement of `r spp` between U.S. and Canadian waters would be beneficial for understanding of extend of `r spp` to help lay the groundwork for future collaborative effort between U.S. and Canada and potential transboundary assessment.
