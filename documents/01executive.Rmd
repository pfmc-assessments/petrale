...
The modeling period begins in 1876, assuming an unfished equilibrium state of the stock in 1875. The assessment treats females and males separately due to differences in biology and life history parameters between sexes, and the coastwide population was modeled allowing separate growth and mortality parameters for each sex (a two-sex model). The model also allows for differences in selectivity between sexes. 
