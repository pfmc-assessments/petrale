...
Age distributions included bins from age 1 to age 17, with the last bin including all fish of greater age. Table \ref{tab:NWcombo_Ages} shows the number of ages taken by the survey.Age distributions were included in the model as conditional-age-at-length observations. The marginal \Gls{s-wcgbt} age-compositions were also included, but only for easier viewing of strong cohorts. The conditional-age-at-length data were not expanded and were binned according to length, age, sex, and year.
