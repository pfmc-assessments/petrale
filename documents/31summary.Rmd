...
Starting with the 2013 stock assessment, the coast-wide stock assessment now summarizes `r spp` landings by the port of landing and combines Washington and Oregon into a single fleet [@haltuch_status_2013]. The 2019 update assessment [@wetzel_status_2019] assumed the same approach as the 2013 stock assessment.
...
Response: For this assessment, WDFW completed catch reconstruction of petrale sole (pers. comm. T. Tsou, WDFW). These newly estimated landings were used in this assessment.  
