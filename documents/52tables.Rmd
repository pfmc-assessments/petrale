...
table_ageing_error(mod_base) %>%
  sa4ss::table_format(
    caption = "Estimated ageing error vectors applied to ages read by the Cooperative Ageing Project (CAP) lab used in the assessment model.",
    label = 'ageing-error-cap'
  )
table_ageing_error(mod_base, matrices = 5:7) %>%
  sa4ss::table_format(
    caption = "Estimated ageing error vectors applied to ages read by the Washington Department of Fish and Wildlife (WDFW) lab used in the assessment model.",
