...
caption = paste("Comparison of biomass time series (colored lines) across recent assessments.",
  "Units are estimated biomass (summary biomass) of females and males ages 3 and older.",
  "Total mortality from the base model (black polygons) is included as well.",
